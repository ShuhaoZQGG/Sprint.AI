/*
  # Sprint.AI Database Schema

  1. New Tables
    - `profiles` - User profiles and authentication data
    - `repositories` - Connected GitHub repositories with analysis data
    - `developers` - Team member profiles and performance metrics
    - `business_specs` - Business specifications for feature development
    - `tasks` - Development tasks with full metadata
    - `sprints` - Sprint planning and tracking data
    - `generated_docs` - AI-generated documentation storage
    - `pr_templates` - Generated PR templates and scaffolds
    - `task_assignments` - Task assignment history and tracking
    - `sprint_tasks` - Many-to-many relationship between sprints and tasks

  2. Security
    - Enable RLS on all tables
    - Add policies for authenticated users to access their team data
    - Implement proper data isolation between teams/organizations
...
-- Developers table (team member profiles)
